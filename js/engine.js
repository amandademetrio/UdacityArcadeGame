...
var Engine = (function(global) {
    ...
    playAgainButton.addEventListener('click', function() {
        console.log("clicked on play again button and player is",player);
        player.victory = false;
        console.log("changed victory to false and player is",player);
        player.resetPosition();
        console.log("after reset position of player, it is", player)
        victoryModal.classList.add('hide');
        console.log("after class toggle, victory modal is",victoryModal)
